...
plot_new_cases_by_month(us_new_cases_all_years, "New cases by month: 2020")
```
...
us_new_cases_2020 %>% 
    ...
    geom_line() +
    geom_point() +
    labs(title="New cases by month: 01/2020 - 04/2022", x="month", y="Cases per month (x 1000)", color="US State") +
